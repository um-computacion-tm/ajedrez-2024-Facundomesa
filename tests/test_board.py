...
class TestTablero(unittest.TestCase):
    ...
    def test_intento_captura_propia_pieza(self):
        ...
        tablero.set_piece(7, 0, Rook("WHITE", self.board))  # Colocar una torre blanca
        tablero.set_piece(6, 0, Pawn("WHITE", self.board))  # Colocar un peón blanco
    ...
    def test_pieza_pasa_sobre_otras(self):
        tablero = Board(forTest=True)  # Usar el modo de prueba
        tablero.set_piece(0, 0, Rook("WHITE", self.board))  # Colocar una torre blanca
        tablero.set_piece(0, 1, Pawn("BLACK", self.board))  # Colocar un peón negro
